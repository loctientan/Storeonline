...
namespace Storeonline.Areas.admin.Controllers
{
    public class NewsController : Controller
    {
        ...
        {
            ViewBag.NewsCategoryID = new SelectList(db.NewsCategories, "NewsCategoryID", "Name");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NewsID,Title,MetaTitle,Description,NewsImage,NewsCategoryID,Details,CreateDate,CreateBy,ModifiedDate,ModifiedBy,Status,TopHot,ViewCount")] News news)
        {
            if (ModelState.IsValid)
            {
